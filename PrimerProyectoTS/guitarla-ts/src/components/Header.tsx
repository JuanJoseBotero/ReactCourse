...
type HeaderProps = {
    ...
    cartIsEmpty: boolean;
    totalToPay: number;
    deleteItem: (guitar: Guitar) => void;
    increaseQuantity: (guitar: Guitar) => void;
    decreaseQuantity: (guitar: Guitar) => void;
    clearCart: () => void;
}

export default function Header({ cart , cartIsEmpty, totalToPay, deleteItem, increaseQuantity, decreaseQuantity, clearCart } : HeaderProps) {
